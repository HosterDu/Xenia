...
import com.demo.user.dto.UserRegistrationDto
...
import ntnu.idatt2105.user.controller.UserController
...
@RestController
class UserControllerImpl(val userService: UserService, val reservationService: ReservationService, val groupService: GroupService) :
    UserController {
